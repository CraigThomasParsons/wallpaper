...
## Limitations
 - Images are in JPG/JPEG
 - This is only meant to work with Feh
...
I'm not sure which part of all this got it to finally work, but I don't want to go through the effort anymore.
This doesn't work in hyprland yet, maybe in the future I'll detect what is being used and the refresh daemon will
update the background using sway
